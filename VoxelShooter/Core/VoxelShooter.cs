...
namespace VoxelShooter
{
    ...
    public class VoxelShooterGame : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            // Freeze all gameplay during "You Died", but keep camera and FPS alive.
            if (youDiedTimer > 0f)
            {
            ...
            // Ship explosion: gameplay frozen but particles keep simulating.
            ...
            if (inputManager.IsHeld(VoxelAction.Fire))
                gameHero.Fire();
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            // Fades in over 0-1500ms, holds 1500-2400ms, fades out 2400-4000ms.
            if (youDiedTimer > 0f)
            {
                float diedElapsed = 4000f - youDiedTimer;
                float diedAlpha   = diedElapsed < 1500f  ? diedElapsed / 1500f          :
                                    diedElapsed < 2400f ? 1f                           :
                                                          (4000f - diedElapsed) / 1600f;
                ...
                spriteBatch.DrawString(font, diedText, diedPos,
                    new Color(0.85f * diedAlpha, 0.05f * diedAlpha, 0.05f * diedAlpha, diedAlpha),
                    0f, Vector2.Zero, diedScale, SpriteEffects.None, 0f);
            }
