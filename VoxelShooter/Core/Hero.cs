...
namespace VoxelShooter
{
    public class Hero : BaseEntity
    {
...
#if DEBUG
        public float[] xpLevels = { 1f, 3f, 6f, 10f, 15f };
#else
        public float[] xpLevels = { 7f, 21f, 42f, 70f, 100f };
#endif
        ...
        /// restores spawn position, and sets <paramref name="health"/>
        /// (typically half the previous starting value as an homage to Demon's Souls).
        /// </summary>
